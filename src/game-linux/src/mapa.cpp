...
// PORT: kopia game/mapa.cpp; jedyna roznica = wspolrzedne zaznaczenia
// poziomu trudnosci na mapie podboju: Rectangle13h 268/313 -> 272/317
// i MWindow 268 -> 272 (obrys plytek z GRAF.DAT blok 21: x=272..317,
// y=148..160 / 163..175 / 178..190). Wzorzec: editor/mapa.cpp:62-108.
// Patrz raporty/overlay-poziomu-mapakampanii.md
/////////////zmienne//////////////////////////
#define RED 148
#define YELLOW 233
#define GRAY 237
...
void DispatchMapEvent(void) {
  ...
  // PORT: fix offsetu overlayu (blad oryginalu; editor/mapa.cpp mial poprawne 272/317)
