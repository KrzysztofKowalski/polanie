...
/*
        UWAGA: PONIŻSZE FUNKCJE WOLNO UŻYWAC TYLKO WÓWCZAS,
               GDY Obecnosc_DPMI() ZWRÓCIŁA ZERO.
*/
/////////////////////////////////////////////////////////////////
// Zwraca 0 gdy przydzielenie sie powiodło
// Zwraca 1 gdy kleska i wtedy zmienia sie znaczenie parametrów:
// Adres_segmentowy = kod błędu systemu DOS
