/*  VESA32.C  -  Example 32-bit program to directly update VESA-compliant video
 * systems. */
...
main(int argc, char *argv[]) {
  ...
  if (VESA_SetMode(ScreenMode) != 0) {
    printf("\nYour display card is not VESA-compliant, or its VESA "
           "implementation\n");
    printf("does not support a resolution of %4dx%3dx256 colors - try a lower "
           "resolution\n\n",
           DWidth, DHeight);
    exit(0);
  }
